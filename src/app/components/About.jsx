...
function About() {
    return (
        <section id='About' className='relative h-auto lg:h-screen w-full pt-24 lg:py-0 lg:min-h-full w-full text-[12px] flex flex-col items-center justify-center snap-start snap-always tracking-widest indent-8 subpixel-antialiased z-10'>
