...
function About() {
    return (
        <section id='About' className='min-h-full h-screen w-full text-[12px] flex flex-col snap-start snap-always tracking-widest indent-8 subpixel-antialiased'>
            <div className="w-3/5 ml-[calc(100%/5+10px)] mr-auto my-auto flex flex-col gap-4">
                <h2 className={`indent-0 opacity-70 text-[80px] text-center font-semibold ${emblemaOne.className} leading-7 text-white dark:text-slate-950 custom-text-shadow`} >About Me</h2>
                <p>
