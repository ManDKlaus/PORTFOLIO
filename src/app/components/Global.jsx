...
function Global() {
    return (
        <section id='Global' className='relative h-full w-full py-10 lg:py-0 lg:min-h-full w-full text-[12px] flex flex-col items-center justify-center snap-start snap-always tracking-widest indent-8 subpixel-antialiased z-30'>
                <Titles title="Global" />
