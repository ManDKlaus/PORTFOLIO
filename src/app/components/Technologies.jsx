...
const Technologies = ({ dark }) => {
  ...
  return (
    <section id='Technologies' className='relative h-[calc(45vh)] lg:min-h-full w-full pt-24 lg:py-0 my-4 mt-8 lg:my-0 pyflex flex-col items-center gap-4 snap-start snap-always z-20' >
