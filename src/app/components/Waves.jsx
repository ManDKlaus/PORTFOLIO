...
function Waves() {
  return (
    <svg
      className='absolute top-0 left-0 w-full h-full block bg-#0e4166 bg-[linear-gradient(to bottom, rgba(14, 65, 102, 0.86), #0e4166)] pointer-events-none'
      version="1.1"
      ...
      <defs>
        <linearGradient id="bg">
          <stop offset="0%" style={{ stopColor: 'rgba(50, 50, 50, 0.8)' }} />
          <stop offset="50%" style={{ stopColor: 'rgba(220, 220, 220, 0.3)' }} />
          <stop offset="100%" style={{ stopColor: 'rgba(210, 210, 210, 0.2)' }} />
        </linearGradient>
